# Cómo contribuir a design-system_vergina-imperial
...
```bash
git clone git@github.com:Alexendros/design-system_vergina-imperial.git
cd design-system_vergina-imperial
pnpm install
pnpm test
```
